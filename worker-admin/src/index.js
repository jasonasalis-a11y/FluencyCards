...
export default {async fetch(request,env){
  ...
  try{
    ...
    if(url.pathname==='/api/health')return json({ok:true,service:'fluency-engine-admin',version:'0.9.3.2',storage:'r2'});
