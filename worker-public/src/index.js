...
export default {async fetch(request,env){
  ...
  try{
    ...
    if(url.pathname==='/api/health')return json({ok:true,service:'fluency-engine-public',version:'0.9.6.2',storage:'r2',pwa:true});
